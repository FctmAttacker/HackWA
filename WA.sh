#!/bin/bash
# HackWA v1.1
# Author: @Darkyellow (You don't become a coder by just changing the credits)
# thanks to: FROM CYBER TO FAMILY
# Github: https://github.com/FctmAttacker/HackWA
...
printf "\n"
printf "     \e[1;92mAuthor: https://github.com/FctmAttacker/HackWA\n\e[0m"
printf "\n"
}
